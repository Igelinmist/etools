...
class BaseRecordForm(forms.Form):
    ...
    wrk = forms.CharField(widget=forms.TextInput(attrs={'size': 4}), initial='0:00', label='Работа')
...
class DownStatRecordForm(BaseRecordForm):
    ...
    rsv = forms.CharField(widget=forms.TextInput(attrs={'size': 4}), initial='0:00', label='РЗ')
    arm = forms.CharField(widget=forms.TextInput(attrs={'size': 4}), initial='0:00', label='АР')
    trm = forms.CharField(widget=forms.TextInput(attrs={'size': 4}), initial='0:00', label='ТР')
    krm = forms.CharField(widget=forms.TextInput(attrs={'size': 4}), initial='0:00', label='КР')
    srm = forms.CharField(widget=forms.TextInput(attrs={'size': 4}), initial='0:00', label='СР')
    rcd = forms.CharField(widget=forms.TextInput(attrs={'size': 4}), initial='0:00', label='РК')
